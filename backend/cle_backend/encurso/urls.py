...
urlpatterns = [
    ...
    path('encurso/generar_pdf_legajo/<int:nro_circuito>/', generar_pdf_legajo, name='generar-pdf-legajo'),
    # Recepcion
    ...
    # Informe Area
    path('encurso/guardar_adjunto_informearea/', GuardarAdjuntoInformeArea.as_view(), name='guardar-adjunto-informearea'),
    path('encurso/guardar_registros_ensayo/', GuardarRegistrosEnsayo.as_view(), name='guardar-registros-ensayo'),
    # Inter Area
    ...
    # Administracion
    path('encurso/obtener_correcciones/<int:nro_circuito>/', obtener_correcciones, name='obtener-correcciones'),
    path('encurso/corregir_informe_servicio/<int:nro_circuito>/', CorregirInformeServicio.as_view(), name= 'corregir-informr-servicio'),
    # Revision
    ...
    path('encurso/advertir_correcciones/<int:nro_circuito>/', AdvertirCorrecciones.as_view(), name='advertir-correcciones'),
    # Firma Dirección
    path('encurso/guardar_adjuntoinformeserviciofirmado/', GuardarAdjuntoInformeServicioFirmado.as_view(), name='guardar-adjuntoinformeservicio-firmado'),
